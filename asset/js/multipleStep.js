$("#multipleStep").validator().on("submit", function (event) {
...
function formSuccess() {
    $("#multipleStep")[0].reset();
    submitMSG(true, "Exito!")
}

function formError() {
    $("#multipleStep").removeClass().addClass('shake animated').one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function () {
        $(this).removeClass();
    });
}
